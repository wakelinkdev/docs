...
Разверните сервер WakeLink с помощью Docker Compose.
...
При первом запуске таблицы создаются автоматически. Для ручной миграции:
...
- [ ] Сгенерируйте уникальные JWT_SECRET и DB_PASSWORD
- [ ] Настройте домен и SSL-сертификаты
- [ ] Задайте корректные CORS_ORIGINS
- [ ] Настройте файрвол (открыты только порты 80/443)
- [ ] Настройте ротацию логов
- [ ] Настройте резервное копирование
- [ ] Настройте мониторинг
- [ ] Проверьте конечные точки работоспособности
- [ ] Выполните нагрузочное тестирование с ожидаемым трафиком
...
Далее: [Справочник по конфигурации →](configuration.md)
